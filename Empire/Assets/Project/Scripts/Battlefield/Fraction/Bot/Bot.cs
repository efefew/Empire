...
public class Bot : MonoBehaviour
{
    ...
    private void Start() => MoveArmy(myFraction.armies[2], new Vector2(3, 3), new Vector2(5, 8));
    ...
    private void MoveArmy(Army army, Vector2 a, Vector2 b) => StartCoroutine(IMoveArmy(army, a, b));
}
