...
namespace AdvancedEditorTools
{
    public class ColumnsExample : MonoBehaviour
    {
        ...
        [Header("Health")] [BeginColumnArea(0.25f)]
        public int health;

        public int maxHealth;

        // To jump to the next column use [NewColumn]
        [Header("Attack")] [NewColumn(0.45f)] public int attackDmg;

        [Range(0, 1)] public float critProp;

        public int secondaryAttackDmg;
        public int magicAttackDmg;

        // To finalize a column section you can use [EndColumnArea]
        [Header("Defense")] [NewColumn] public int baseDefense;
        ...
        [BeginColumnArea(0.225f, areaStyle = LayoutStyle.None, columnStyle = LayoutStyle.Bevel)]
        public int test1;

        [NewColumn(0.225f)] public int test2;

        [EndColumnArea] public int test3;
        ...
        [EndColumnArea(includeLast = true)] public int test5;
    }
}