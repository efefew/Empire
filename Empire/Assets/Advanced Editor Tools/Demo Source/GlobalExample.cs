...
namespace AdvancedEditorTools
{
    ...
    public class TestClass
    {
        ...
        [SerializeField] private int iShouldBeSerialized;

        [SerializeReference] private GlobalExample iShouldBeSerializedToo;
    ...
    public class GlobalExample : MonoBehaviour
    {
        ...
        [NewColumn(LayoutStyle.BevelRed)] public int num4;

        public int num5;

        [BeginFoldout("My fold")] public int num6;

        [BeginFoldout("My fold 2")] public int num7;

        [EndFoldout] [EndFoldout] [NewColumn(LayoutStyle.BevelCyan)]
        public int num8;

        [ReadOnly] [Tooltip("This variable is public but cannot be mofified by hand")]
        public int num9;

        public int num10;

        [EndColumnArea] [BeginColumnArea] [BeginFoldout("Basic types")]
        public byte byteVal2;

        public char charVal;
        public int intVal;

        [ReadOnly] [Range(0, 10)] public float floatVal;

        public bool boolVal;

        [EndFoldout] [NewColumn] [BeginFoldout("Unity Structs")] [TextArea]
        ...
        [EndFoldout] public Hash128 hash128;
        ...
        [NewColumn] [Header("Object References")]
        public GlobalExample monoObj;

        public Texture obj;

        [EndColumnArea] [EndFoldout] [BeginFoldout("Advanced Data Types")] [BeginFoldout("Enumerables")]
        public int[] arrTest;

        public List<float> listTest = new();

        [EndFoldout] [BeginFoldout("Custom Types")]
        public TestEnum testEnum;

        public MyStruct structTest;

        [EndFoldout(includeLast = true)] [EndFoldout(includeLast = true)]
